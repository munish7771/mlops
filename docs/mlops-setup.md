...
git add README.md docs .gitignore sample_project/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[sample_project/databricks.yml](../sample_project/databricks.yml) file.
...
Follow the instructions in [sample_project/resources/README.md](../sample_project/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../sample_project/resources/README.md)  to propose, test, and deploy
