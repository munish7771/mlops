...
Opening a pull request will trigger a[workflow](../.github/workflows/sample_project-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/staging/sample_project/sample_project-model)
* [Prod model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/prod/sample_project/sample_project-model)
. 
